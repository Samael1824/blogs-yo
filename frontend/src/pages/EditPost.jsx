...
const EditPost = () => {
  ...
  return (
    <div>
        ...
        <h1 className='font-bold md:text-2xl text-xl '>Actualizar a publicacion</h1>
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          ...
          <button onClick={handleUpdate} className='bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg'>Actualizar</button>
        </form>
