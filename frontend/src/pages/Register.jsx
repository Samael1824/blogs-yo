...
const Register = () => {
  ...
  return (
    ...
    <h3><Link to="/login">Inicia sesion</Link></h3>
    </div>
    <div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         <h1 className="text-xl font-bold text-left">Crea una cuenta</h1>
         ...
         {error && <h3 className="text-red-500 text-sm ">Algo ha salido mal!</h3>}
         <div className="flex justify-center items-center space-x-3">
          <p>Ya tienes una cuenta?</p>
          <p className="text-gray-500 hover:text-black"><Link to="/login">Inicia sesion</Link></p>
         </div>
       </div>
    </div>
    <Footer/>
